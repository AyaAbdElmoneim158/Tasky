...
class AppColors {
  ...
  static const Color lightPrimary = Color(0xFFEBE5FF);
  ...
  static const Color textDarkerGrey = Color(0xFF2F2F2F);
  ...
  static const Color profileCard = Color(0xffF5F5F5);
