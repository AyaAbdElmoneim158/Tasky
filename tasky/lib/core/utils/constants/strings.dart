abstract class AppStrings {
  static String appTitle = 'Tasky';
  static String appFontFamily = "DMSans";

  static String loremText =
      "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s";

  static String welcomeTitle = "Task Management &\nTo-Do List";
  ...
  static const String alreadyHaveAccount = 'Already have any account?';
  static const String signIn = 'Sign in';
  static const String didNotHaveAccount = 'Didn’t have any account?';
